...
(event.category in ("dns","url","ip")) and (endpoint.os="windows" and (url.address contains "beanywhere.com" or event.dns.request contains "beanywhere.com"))
```
...
detection:
    selection:
        DestinationHostname|endswith: 'beanywhere.com'
    condition: selection
falsepositives:

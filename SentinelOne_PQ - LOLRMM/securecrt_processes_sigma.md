...
event.type="Process Creation" and (endpoint.os="windows" and (src.process.image.path contains "\\SecureCRT.EXE" or tgt.process.image.path contains "\\SecureCRT.EXE"))
```
...
detection:
    selection_parent:
        ParentImage|endswith: '\\SecureCRT.EXE'
    selection_image:
        Image|endswith: '\\SecureCRT.EXE'

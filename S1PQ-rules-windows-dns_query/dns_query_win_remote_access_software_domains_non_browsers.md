```sql
// Translated content (automatically translated on 08-09-2026 04:11:16):
...
level: medium
regression_tests_path: regression_data/rules/windows/dns_query/dns_query_win_remote_access_software_domains_non_browsers/info.yml
```

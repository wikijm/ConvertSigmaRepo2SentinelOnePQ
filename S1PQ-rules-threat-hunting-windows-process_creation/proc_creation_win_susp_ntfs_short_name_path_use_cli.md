```sql
// Translated content (automatically translated on 10-09-2026 01:51:55):
...
level: medium
regression_tests_path: regression_data/rules-threat-hunting/windows/process_creation/proc_creation_win_susp_ntfs_short_name_path_use_cli/info.yml
```

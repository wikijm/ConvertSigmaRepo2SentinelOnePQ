...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\uxcore.dll" and (not (module.path in ("c:\\program files\\windows live\\installer\*","c:\\program files (x86)\\windows live\\installer\*")))))
```

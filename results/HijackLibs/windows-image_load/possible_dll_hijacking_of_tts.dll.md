...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\tts.dll" and (not (module.path in ("c:\\program files\\Soundpad\*","c:\\program files (x86)\\Soundpad\*")))))
```

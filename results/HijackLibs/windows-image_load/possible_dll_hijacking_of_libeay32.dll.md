...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\libeay32.dll" and (not (module.path contains "c:\\program files\\PSPad editor\\" or module.path contains "c:\\program files (x86)\\PSPad editor\\"))))
```

...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\isv.exe_rsaenh.dll" and (not (module.path in ("c:\windows\system32\*","c:\windows\syswow64\*")))))
```

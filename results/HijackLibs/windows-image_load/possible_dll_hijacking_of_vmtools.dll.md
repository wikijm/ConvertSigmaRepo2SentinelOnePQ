...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\vmtools.dll" and (not (module.path contains "c:\\program files\\VMware\\VMware Tools\\" or module.path contains "c:\\program files (x86)\\VMware\\VMware Tools\\" or module.path contains "c:\\program files\\VMware\\VMware Workstation\\" or module.path contains "c:\\program files (x86)\\VMware\\VMware Workstation\\" or module.path contains "c:\\program files\\VMware\\VMware Player\\" or module.path contains "c:\\program files (x86)\\VMware\\VMware Player\\"))))
```

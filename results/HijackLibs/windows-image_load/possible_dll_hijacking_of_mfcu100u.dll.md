...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\mfcu100u.dll" and (not (module.path in ("c:\program files\TechSmith\Camtasia Studio 8\*","c:\program files (x86)\TechSmith\Camtasia Studio 8\*")))))
```

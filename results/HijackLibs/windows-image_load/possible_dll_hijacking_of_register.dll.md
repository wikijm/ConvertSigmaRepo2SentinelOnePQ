...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\register.dll" and (not (module.path in ("c:\program files\IObit\Driver Booster\*\*","c:\program files (x86)\IObit\Driver Booster\*\*")))))
```

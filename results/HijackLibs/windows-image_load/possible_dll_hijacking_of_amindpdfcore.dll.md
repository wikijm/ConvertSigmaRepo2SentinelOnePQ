...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\amindpdfcore.dll" and (not (module.path in ("c:\\program files\\GeekerPDF\\GeekerPDF\*","c:\\program files (x86)\\GeekerPDF\\GeekerPDF\*")))))
```

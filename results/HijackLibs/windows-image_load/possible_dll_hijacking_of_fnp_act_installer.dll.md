...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\fnp_act_installer.dll" and (not (module.path in ("c:\\program files\\InstallShield\*\\System\*","c:\\program files (x86)\\InstallShield\*\\System\*")))))
```

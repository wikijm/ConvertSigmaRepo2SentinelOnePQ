...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\skinutils.dll" and (not (module.path in ("c:\\program files\\ICQLite\*","c:\\program files (x86)\\ICQLite\*")))))
```

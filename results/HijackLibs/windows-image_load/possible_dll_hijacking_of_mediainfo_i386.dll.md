...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\mediainfo_i386.dll" and (not (module.path in ("c:\program files\MediaInfo\*","c:\program files (x86)\MediaInfo\*")))))
```

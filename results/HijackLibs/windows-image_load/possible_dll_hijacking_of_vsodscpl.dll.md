...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\vsodscpl.dll" and (not (module.path in ("c:\\program files\\McAfee\\VirusScan Enterprise\*","c:\\program files (x86)\\McAfee\\VirusScan Enterprise\*")))))
```

...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\mfc140u.dll" and (not (module.path in ("c:\program files\CheckMAL\AppCheck\*","c:\program files (x86)\CheckMAL\AppCheck\*")))))
```

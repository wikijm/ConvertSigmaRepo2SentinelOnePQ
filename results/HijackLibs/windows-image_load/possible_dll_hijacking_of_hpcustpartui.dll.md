...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\hpcustpartui.dll" and (not (module.path contains "c:\\program files\\HP\\" or module.path contains "c:\\program files (x86)\\HP\\"))))
```

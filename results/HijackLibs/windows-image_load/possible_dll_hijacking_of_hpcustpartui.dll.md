...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\hpcustpartui.dll" and (not (module.path in ("c:\\program files\\HP\*","c:\\program files (x86)\\HP\*")))))
```

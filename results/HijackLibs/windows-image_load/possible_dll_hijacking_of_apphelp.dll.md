...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\apphelp.dll" and (not (module.path contains "c:\\windows\\system32\\" or module.path contains "c:\\windows\\syswow64\\"))))
```

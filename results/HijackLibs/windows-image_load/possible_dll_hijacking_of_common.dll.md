...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\common.dll" and (not (module.path in ("c:\program files\iroot\*","c:\program files (x86)\iroot\*")))))
```

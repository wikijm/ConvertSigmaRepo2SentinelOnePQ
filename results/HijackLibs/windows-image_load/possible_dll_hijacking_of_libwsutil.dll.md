...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\libwsutil.dll" and (not (module.path in ("c:\program files\Wireshark\*","c:\program files (x86)\Wireshark\*")))))
```

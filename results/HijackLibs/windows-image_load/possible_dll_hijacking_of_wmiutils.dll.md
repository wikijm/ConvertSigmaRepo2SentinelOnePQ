...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\wmiutils.dll" and (not (module.path in ("c:\\windows\\system32\\wbem\*","c:\\windows\\syswow64\\wbem\*")))))
```

...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\wbemsvc.dll" and (not (module.path contains "c:\\windows\\system32\\wbem\\" or module.path contains "c:\\windows\\syswow64\\wbem\\"))))
```

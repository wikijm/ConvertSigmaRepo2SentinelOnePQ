...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\ssp_isv.exe_rsaenh.dll" and (not (module.path in ("c:\\windows\\system32\*","c:\\windows\\syswow64\*")))))
```

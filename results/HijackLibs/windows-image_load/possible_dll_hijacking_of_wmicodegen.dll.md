...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\wmicodegen.dll" and (not (module.path in ("c:\program files\windows kits\*\bin\*\*","c:\program files (x86)\windows kits\*\bin\*\*")))))
```

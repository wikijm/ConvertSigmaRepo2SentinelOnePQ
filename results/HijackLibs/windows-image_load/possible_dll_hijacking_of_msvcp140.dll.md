...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\msvcp140.dll" and (not (module.path in ("c:\windows\system32\*","c:\windows\syswow64\*","c:\program files\*","c:\program files (x86)\*")))))
```

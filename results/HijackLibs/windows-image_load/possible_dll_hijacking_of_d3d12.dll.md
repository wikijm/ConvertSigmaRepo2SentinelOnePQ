...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\d3d12.dll" and (not (module.path contains "c:\\windows\\system32\\" or module.path contains "c:\\windows\\syswow64\\"))))
```

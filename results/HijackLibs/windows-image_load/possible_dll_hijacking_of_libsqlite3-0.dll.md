...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\libsqlite3-0.dll" and (not (module.path contains "c:\\program files\\" or module.path contains "c:\\program files (x86)\\"))))
```

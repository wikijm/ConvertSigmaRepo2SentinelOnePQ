...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\sqlite.dll" and (not (module.path in ("c:\\program files\\NetWorx\*","c:\\program files (x86)\\NetWorx\*")))))
```

...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\libglib-2.0-0.dll" and (not (module.path contains "c:\\program files\\Wireshark\\" or module.path contains "c:\\program files (x86)\\Wireshark\\"))))
```

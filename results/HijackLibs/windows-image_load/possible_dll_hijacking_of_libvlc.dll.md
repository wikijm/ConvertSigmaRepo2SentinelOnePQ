...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\libvlc.dll" and (not (module.path contains "c:\\program files\\VideoLAN\\VLC\\" or module.path contains "c:\\program files (x86)\\VideoLAN\\VLC\\"))))
```

...
event.type="ModuleLoad" and (endpoint.os="windows" and (module.path contains "\libvlc.dll" and (not (module.path in ("c:\program files\VideoLAN\VLC\*","c:\program files (x86)\VideoLAN\VLC\*")))))
```

...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\d3d10_1core.dll" and (not (not (module.path matches "\.*") or not (module.path matches "\.*") or not (module.path matches "\.*")))))
```

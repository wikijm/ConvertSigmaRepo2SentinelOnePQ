...
event.type="Module Load" and (endpoint.os="windows" and (module.path contains "\\d3dx9_43.dll" and (not (not (module.path matches "\.*") or not (module.path matches "\.*") or not (module.path matches "\.*")))))
```
